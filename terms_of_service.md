...
Hizmete erişerek veya Hizmeti kullanarak, bu Şartlar'a bağlı kalmayı kabul etmiş sayılırsınız.
...
Kullanıcı olarak şunları kabul edersiniz:
    ...
    Doğru Bilgi: Hizmetin doğru çalışması için sizden istenen Okul Numarası ve Uygulama Grubu gibi bilgileri doğru ve eksiksiz sağlamak sizin sorumluluğunuzdadır. Yanlış bilgi verilmesi, ders programınızın hatalı oluşmasına neden olabilir.

    Google Hesabı: Hizmetin çalışması, aktif bir Google hesabına ve Google Takvim'inize erişim için bize verdiğiniz yetkiye (OAuth2) bağlıdır. Google hesabınızın güvenliğinden siz sorumlusunuz.

    Yasal Kullanım: Hizmeti yalnızca yasal amaçlarla kullanmayı, sistemin çalışmasına müdahale etmemeyi veya yetkisiz erişim sağlamaya çalışmamayı taahhüt edersiniz.

3. Gizlilik ve Veri Kullanımı

Verilerinizin gizliliği bizim için esastır. Hangi verileri neden topladığımızı ve bunları nasıl kullandığımızı (veya kullanmadığımızı) detaylı bir şekilde açıkladığımız Gizlilik Politikamızı okumuş ve kabul etmiş sayılırsınız.

    Gizlilik Politikası'na buradan ulaşabilirsiniz.

Özetle; Google Takviminizdeki mevcut kişisel verilerinizi okumaz, saklamaz veya işlemeyiz. Tek amacımız, okul programını takviminize yazmaktır.
...
Hizmet Sağlayıcıları olarak, herhangi bir zamanda, önceden haber vererek veya vermeksizin, Hizmet'in tamamını veya bir kısmını geçici olarak durdurma, değiştirme veya kalıcı olarak sonlandırma hakkını saklı tutarız.

Bu Şartlar'ın ihlali durumunda, Kullanıcı'nın Hizmet'e erişimini derhal askıya alma veya sonlandırma hakkımız saklıdır.
