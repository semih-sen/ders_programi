            ...
            <details className="relative z-50">
              ...
              <div className="absolute right-0 mt-2 w-64 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-[100]">
                ...
                Analizler
                  ...
                  <MobileNavLink href="/admin/bulk-delete-events" icon={<ClipboardIcon />}>
                    Toplu Etkinlik Silme
                  </MobileNavLink>
                  <MobileNavLink href="/admin/bulk-ban" icon={<ClipboardIcon />}>
                    Toplu Ban
                  </MobileNavLink>
        ...
        <aside className="hidden lg:block w-64 min-h-screen bg-slate-900/50 border-r border-slate-700 backdrop-blur-sm">
          <div className="p-6">
            ...
            <nav className="space-y-2">
              ...
              <NavLink href="/admin/bulk-delete-events" icon={<ClipboardIcon />}>
                Toplu Etkinlik Silme
              </NavLink>
              <NavLink href="/admin/bulk-ban" icon={<ClipboardIcon />}>
                Toplu Ban
              </NavLink>
